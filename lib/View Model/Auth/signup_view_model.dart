...
class AuthSignupViewModel extends StatefulWidget {
  const AuthSignupViewModel({super.key});

  @override
  State<AuthSignupViewModel> createState() => _AuthSignupViewModelState();
}

class _AuthSignupViewModelState extends State<AuthSignupViewModel> {
                ...
                onpress: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    auth.createUserWithEmailAndPassword(
                      ...
                      ErrorMessage.toastMessage("Sucessfully submit");
                ...
                children: [
                  ...
                  TextButton(
                      ...
                      child: Text(
                        "Login",
                        style: TextStyle(
                            color: Colors.lime.shade800, fontSize: 18),
                      )),
                ],
              ),
            ]),
